PUBLISHING_IMAGE := ministryofjustice/cloud-platform-tech-docs-publisher:1.6
...
htmlproofer:
	docker run --rm \
		...
		-p 4567:4567 \
		$(PUBLISHING_IMAGE) \
		bundle exec htmlproofer ./docs --http-status-ignore 429 --allow-hash-href --http-status-ignore 0,429 --url-swap "https?\:\/\/tech-docs\.hmpps\.service\.justice\.gov\.uk:" ./docs
